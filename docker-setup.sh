...
OPENCLAW_CONFIG_DIR="${OPENCLAW_CONFIG_DIR:-$HOME/.openclaw_docker}"
OPENCLAW_WORKSPACE_DIR="${OPENCLAW_WORKSPACE_DIR:-$HOME/.openclaw_docker/workspace}"
...
export OPENCLAW_BRIDGE_PORT="${OPENCLAW_BRIDGE_PORT:-18791}"
